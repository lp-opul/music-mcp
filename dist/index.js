    ...
    try {
        switch (name) {
            ...
            case 'upload_track': {
                ...
                if (dittoClient) {
                    ...
                    if (validated.audioUrl) {
                        ...
                        result = await dittoClient.createTrackWithAudio(releaseId, validated.audioUrl, `${validated.title.replace(/[^a-zA-Z0-9]/g, '_')}.mp3`);
                    }
                    else {
            ...
            case 'submit_release': {
                ...
                if (dittoClient) {
                    ...
                    for (const dsp of validated.dsps) {
                        const storeId = await getStoreId(dsp);
                        if (storeId)
            ...
            case 'get_earnings': {
                ...
                if (dittoClient) {
                    const storeId = validated.dsp ? await getStoreId(validated.dsp) : undefined;
